...
class Board:
    ...
    #             legal_moves.extend(piece.get_valid_moves(self))
    #     return legal_moves
    #
    ...
    #     return self.is_in_checkmate('white') or self.is_in_checkmate('black') or self.is_in_stalemate()
    #
    # def is_in_stalemate(self):
    #     pass
    #
    # def push(self, move):
    #     start_x, start_y = move.from_square % 8, move.from_square // 8
    #     end_x, end_y = move.to_square % 8, move.to_square // 8
    #     start_square = self.get_square_from_pos((start_x, start_y))
    #     end_square = self.get_square_from_pos((end_x, end_y))
