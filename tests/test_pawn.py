...
class PawnTests(unittest.TestCase):
    ...
    def test_move_diagonal_if_captured(self):
        pawn = Pawn('black', (0, 3))  # PASSING A BLACK PIECE ON TILE 0,3, DOESN'T NEED IMAGE INPUT
        pawn.calculate_valid_moves([(1, 2)], [])  # PASSING W.LOCATION TO THE CALCULATE VALID MOVES FUNC
    ...
    # todo: can't do this yet with setup
    ...
    #     valid_moves = pawn.calculate_valid_moves([(1, 2)], [])  # PASSING WHITE CO-ORDS THAT WOULD ALLOW CAPTURING
    #     self.assertEqual([(1, 2)], valid_moves)  # THE TWO POSSIBLE CO-ORDS FOR THE BLACK PIECE TO MOVE TO
