...
class TestButtonAndImage(unittest.TestCase):
    ...
    def test_button_initialization(self):
        ...
        self.assertEqual(self.button.rect, self.button_image.get_rect.return_value)
    ...
    #     screen.blit.assert_called_with(self.button_image, self.button.rect)
    #     screen.blit.assert_called_with(self.button_font.render.return_value,
    ...
    def test_image_on_screen_initialization(self):
        ...
        self.assertEqual(self.image_on_screen.rect, self.image.get_rect.return_value)

    def test_image_on_screen_update(self):
        screen = Mock()
        self.image_on_screen.update(screen)
        screen.blit.assert_called_with(self.image, self.image.get_rect.return_value)

    # def test_image_on_screen_check_for_input(self):
    #     position_inside_image = (210, 210)
    #     position_outside_image = (190, 190)
    #
