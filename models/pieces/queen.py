...
class Queen(Piece):
    ...
    def calculate_valid_moves(self, move_history, white_locations, black_locations, settings):
        ...
        rook_valid_moves = rook.calculate_valid_moves(move_history, white_locations, black_locations, settings)
        moves_list.extend(rook_valid_moves)

        # same for bishop
        bishop = Bishop(self._colour, self.get_current_position())
        bishop_valid_moves = bishop.calculate_valid_moves(move_history, white_locations, black_locations, settings)
